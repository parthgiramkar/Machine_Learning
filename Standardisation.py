...
Pandas DataFrame stores data in tabular form, while .values extracts only  Pandas DataFrame stores data in tabular form, while .values extracts onlythe raw numerical values as a NumPy array.
